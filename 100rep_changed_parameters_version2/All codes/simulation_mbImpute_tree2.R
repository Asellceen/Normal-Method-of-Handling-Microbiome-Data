...
results_mbImpute_tree2<- replicate_function(100, n=98, k= 62, ni=ni_combo, otu_list= otu_list_tree2,
                                         true_abundance= true_abundance_combo2, D_phylo= D_phylo_combo2)
save(results_mbImpute_tree2, file= "results_mbImpute_tree2.RData")
