...
load("imputed_ZIDTM_tree2.RData")
...
save(Frobenius_error_ZIDTM_tree2, file= "Frobenius_error_ZIDTM_tree2.RData")
save(Simpson_index_ZIDTM_tree2, file= "Simpson_index_ZIDTM_tree2.RData")
save(Wasserstein_Distance_ZIDTM_tree2, file= "Wasserstein_Distance_ZIDTM_tree2.RData")
save(zero_proportion_imupted_ZIDTM_tree2, file= "zero_proportion_imupted_ZIDTM_tree2.RData")
