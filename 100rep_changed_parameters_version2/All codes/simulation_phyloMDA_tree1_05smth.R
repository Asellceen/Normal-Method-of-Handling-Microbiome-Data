...
results_phylo_tree1_05smth<- replicate_function(100, otu_list= otu_list_tree1,
                                         true_abundance= true_abundance_combo1, 
                                         phylo_tree = COMBO_tree1)
save(results_phylo_tree1_05smth, file= "results_phylo_tree1_05smth.RData")
