...
prop_zeros_noColZeros_ZIDTM_tree2<- list()
column_remove_ZIDTM_tree2<- list()
time_ZIDTM_tree2<- list() 
for (i in 1:100){
  temp_value<- fitting_phylo(otu_list_tree2[[i]], COMBO_tree2)
  imputed_ZIDTM_tree2[[i]]<- temp_value$imputed_value_ZIDTM
  prop_zeros_noColZeros_ZIDTM_tree2[[i]]<- temp_value$prop_zeros_noColZeros
  column_remove_ZIDTM_tree2[[i]]<- temp_value$column_remove
  time_ZIDTM_tree2[[i]]<- temp_value$time_ZIDTM
}
save(imputed_ZIDTM_tree2, file= "imputed_ZIDTM_tree2.RData")
save(prop_zeros_noColZeros_ZIDTM_tree2, file= "prop_zeros_noColZeros_ZIDTM_tree2.RData")
save(column_remove_ZIDTM_tree2, file= "column_remove_ZIDTM_tree2.RData")
save(time_ZIDTM_tree2, file= "time_ZIDTM_tree2.RData")